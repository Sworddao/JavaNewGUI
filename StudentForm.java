...
public class StudentForm extends JFrame implements ActionListener {
    ...
    private JPanel titlePanel, sidebarPanel, formPanel, resultPanel, advancedEventPanel;
    private JPanel row1, row2, row3, row4, row5;

    private JLabel label, nameLbl, courseLabel, genderLabel, hobbiesLabel, countLabel, mouseCoordinate;
